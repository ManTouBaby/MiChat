...
public class ChatMessage extends BaseSmartBO {
    ...
    @JSONField(serialize = false)
    private String messageLocalContent;//本地缓存，用于存储本地的文件路径
    @JSONField(serialize = false)
...
//    private String messageFrom;//消息来自
    ...
    public String getMessageLocalContent() {
        return messageLocalContent;
    }

    public void setMessageLocalContent(String messageLocalContent) {
        this.messageLocalContent = messageLocalContent;
    }
    ...
    public String toString() {
        return "ChatMessage{" +
                ...
                ", messageLocalContent='" + messageLocalContent + '\'' +
                ", messageCT='" + messageCT + '\'' +
